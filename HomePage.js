...
function HomePage() {
  ...
  useEffect(() => {
    const mockVideos = [
      ...
      },
      {
        ...
        description: "Cours d'électricité pour débutants.",
      ...
      },
      {
        ...
        description: "Introduction simple à la chimie.",
      ...
      },
      {
        ...
        description: "Les grandes étapes de la révolution.",
        authorAvatar: "https://i.pravatar.cc/150?img=5"
      },
      {
        id: 6,
        title: "Cours de géographie - Les continents",
        category: "Géographie",
        thumbnail: "https://img.youtube.com/vi/TbbqfwRAkdk/0.jpg",
        url: "https://www.youtube.com/embed/TbbqfwRAkdk",
        description: "Apprenez les continents en vidéo.",
        authorAvatar: "https://i.pravatar.cc/150?img=6"
      },
      {
        id: 7,
        title: "Cours de français : Le verbe",
        category: "Français",
      ...
      },
      {
        ...
        description: "Le système digestif expliqué simplement.",
      ...
      },
      {
        ...
        description: "Cours de dessin pour débutants.",
  ...
  return (
    <Container className="mt-4">
      <h2 className="mb-4">Vidéos éducatives 📚</h2>
      <Row>
        {videos.length > 0 ? (
          videos.map(video => (
